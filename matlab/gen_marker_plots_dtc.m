...
%
% Writes to
%   <ANALYSIS_ROOT>\preprocessing\<Marker>_plots\qc<reads>_<genes>_ge<cut>_sat<cap>_<cmap>\
...
out_dir = fullfile(analysis_root, 'preprocessing', [MARKER_LABEL '_plots'], param_dir);
